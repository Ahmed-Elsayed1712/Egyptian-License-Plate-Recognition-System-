...
import io
import tempfile
import depiweb  # استيراد المنطق من الملف الخارجي
...
<style>
    .stApp {{
        background-image: url("https://images.pexels.com/photos/2149908/pexels-photo-2149908.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1");
    ...
    if not uploaded_file.type.startswith('image/'):
        ...
        with st.spinner(LANGUAGES[lang]["processing"]):
            try:
                ...
                results = depiweb.license_plate_detection_pipeline(
                    temp_image_path,
                    depiweb.yolo_model,
                    depiweb.plate_model,
                    depiweb.ocr_model
